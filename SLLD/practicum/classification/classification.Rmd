...
The linear discriminant function from the results above can be identified using the Coefficients of Linear discriminants. The “proportion of trace”" represents the percentage separation achieved by each discriminant function.
...
Note that ‘prior probability’ and ‘Group Means’ values are same as of LDA.
